    ...
    const createFirstCardContent = () => (
        <div className="grid grid-cols-10 grid-rows-10 h-full">
            <div className=" col-start-2 col-span-9 row-start-2 row-span-9">
                <div className="flex flex-col gap-10 h-full justify-center items-start">
                    ...
                    <p className="text-base md:text-lg text-black self-end font-semibold">In few simple steps</p>
                </div>
            </div>
        </div>
    );
